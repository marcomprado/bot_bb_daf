...
#memorize ✅ Abordagem de seletores XPath para dropdowns Select2:

  Para dropdowns Select2, usar:
  //span[@id='select2-chosen-X']/parent::a

  Vantagens desta abordagem:
  - ✅ Usa apenas o ID único do span (mais confiável)
  - ✅ Navega para o elemento pai <a> que precisa ser clicado
  - ✅ Não depende de classes CSS específicas que podem mudar
  - ✅ Sintaxe XPath mais simples e estável
  - ✅ Funciona consistentemente em diferentes contextos